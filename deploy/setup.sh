...
PROJECT_GIT_URL='https://github.com/gonulalan/budi-food-api.git'
...
cp $PROJECT_BASE_PATH/deploy/supervisor_users_api.conf /etc/supervisor/conf.d/users_api.conf
